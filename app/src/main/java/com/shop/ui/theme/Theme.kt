...
private val LightColorPalette = ShopColors(
    brand = Shadow5,
...
private val DarkColorPalette = ShopColors(
    brand = Shadow1,
...
object ShopTheme {
    val colors: ShopColors
        @Composable
        get() = LocalShopColors.current
}

/**
 * Shop custom Color Palette
 */
@Stable
class ShopColors(
    ...
    fun copy(): ShopColors = ShopColors(
...
fun ProvideShopColors(
    ...
    CompositionLocalProvider(LocalShopColors provides colorPalette, content = content)
}

private val LocalShopColors = staticCompositionLocalOf<ShopColors> {
    error("No ShopColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [ShopTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
